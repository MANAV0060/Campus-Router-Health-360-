...
export const DemoModeBanner: React.FC<DemoModeBannerProps> = ({ onSelectRouter }) => {
  return (
    <div className="glass-card p-4 rounded-2xl border border-cyan-500/30 bg-gradient-to-r from-cyan-950/30 via-transparent to-rose-950/20 mb-6 shadow-xl relative overflow-hidden">
