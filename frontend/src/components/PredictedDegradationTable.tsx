...
export const PredictedDegradationTable: React.FC<PredictedDegradationTableProps> = ({
  ...
  return (
    <div className="glass-card rounded-2xl border border-white/10 overflow-hidden mb-8 shadow-2xl">
          ...
          <div className="flex flex-wrap items-center gap-2.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="bg-gray-900/90 border border-white/10 rounded-xl pl-9 pr-3 py-1.5 text-xs text-white placeholder-gray-500 focus:outline-none focus:border-cyan-400 w-52 transition-all"
              />
            </div>
            ...
            <select
              ...
              className="bg-gray-900 border border-white/10 rounded-xl px-3 py-1.5 text-xs text-gray-200 focus:outline-none focus:border-cyan-400"
            >
            ...
            <select
              ...
              className="bg-gray-900 border border-cyan-500/30 rounded-xl px-3 py-1.5 text-xs text-cyan-300 font-semibold focus:outline-none focus:border-cyan-400"
            >
        ...
        <table className="w-full">
          <thead>
            <tr>
              ...
              <th className="text-rose-400">AI Future Risk (Next 24h)</th>
              <th>Priority Score</th>
              <th>Top Risk Contributor (SHAP)</th>
              ...
              routers.map((router) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Location */}
                    <td>
                      <div className="text-xs font-medium text-gray-200">{router.building}</div>
                      <div className="text-[11px] text-gray-500">Room {router.room} &bull; {router.user_type}</div>
                    </td>
                    ...
                    <td>
                      {topContrib ? (
                        <div>
                          <div className="text-xs text-gray-200 font-medium truncate max-w-[170px]" title={topContrib.display_name}>
                    ...
                    {/* Recommended Action */}
                    <td>
                      <span className="text-xs font-semibold text-cyan-300 bg-cyan-950/40 border border-cyan-500/30 px-2.5 py-1 rounded-lg block text-center truncate max-w-[180px]" title={router.recommended_action}>
                    ...
                    <td className="text-right">
                      <button
                        ...
                        className="p-1.5 rounded-lg bg-white/5 hover:bg-cyan-500/20 text-gray-400 hover:text-cyan-300 transition-all cursor-pointer"
